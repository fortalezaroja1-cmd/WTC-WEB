...
import { LayoutDashboard, Boxes, ClipboardList, Package, Users, Settings, Store, LogOut, BellRing, MessageCircle } from "lucide-react";

const NAV = [
  { href: "/admin", label: "Panel", icon: LayoutDashboard },
  { href: "/admin/inbox", label: "Bandeja", icon: MessageCircle },
  ...
  return (
    <div className="flex min-h-screen bg-paper">
      ...
      <main className="flex-1 min-w-0">
        {newOrders > 0 && pathname !== "/admin/pedidos" && pathname !== "/admin/crm" && pathname !== "/admin/inbox" && (
          <Link href="/admin/inbox" className="mx-7 mt-5 flex items-center gap-2 rounded-lg border border-copper/30 bg-amber-50 px-4 py-3 text-sm font-semibold text-slate-dark hover:border-copper transition-colors">
