          ...
          <div className="min-w-0">
            ...
            <div className="p-4 2xl:p-5 space-y-5 min-w-0">
              <section>
                ...
                <select disabled={busy} value={current.status || "NEW"} onChange={(e) => updateLead({ status: e.target.value })} className="w-full min-w-0 border border-hair rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-copper">
