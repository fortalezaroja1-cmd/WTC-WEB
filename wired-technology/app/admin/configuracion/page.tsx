...
export default function ConfiguracionPage(){
  ...
  useEffect(()=>{ fetch("/api/admin/settings").then(r=>r.json()).then((d)=>setCfg({ workStart:"06:00", workEnd:"19:00", saturdayStart:"07:00", saturdayEnd:"14:00", responseSlaMinutes:"10", followupHours:"24", ...d })); },[]);
  const save=async()=>{
    setSaving(true);
    const allowed:any={};
