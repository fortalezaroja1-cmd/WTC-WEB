...
export default function WiredAssistant({ audience }: Props) {
  ...
  const [turns,setTurns]=useState<Turn[]>([{role:"agent",text: audience==="team" ? "Hola. Soy el asistente de Wired. Puedo ayudarte con catálogo, ventas y dudas de operación." : "Hola 👋 Soy el asesor virtual de Wired. Cuéntame qué producto necesitas y te ayudo a encontrar la referencia adecuada."}]);
